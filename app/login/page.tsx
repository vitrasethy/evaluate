...
export default function Home() {
  return (
    <main className="bg-[url('/stem.jpeg')] bg-cover h-screen">
      <div className="flex flex-wrap justify-evenly max-sm:justify-center items-center bg-sky-950/30 backdrop-brightness-75 h-full">
...
>>>>>>> refs/remotes/origin/main
          ...
          <Link href="/register">
            <div className="text-center mt-2">
              ...
              <button className="mt-4 bg-[#024164] hover:bg-[#03679d] w-full px-3 py-3 text-sm md:text-lg leading-5 rounded-md font-semibold text-white">
                Register
              </button>
            </div>
          </Link>
